...
☐ 1. [auto] project-a: Remove 12 broken INDEX.jsonl references
...
☐ 3. [guided] project-a: Review IMPORTANT keyword usage (7 found, Anthropic uses 4)
     Evidence: Anthropic 265 versions: 12→4
☐ 4. [guided] project-f: CLAUDE.md not updated in 45 days
...
```bash
node "$HH_DIR/src/fixer.js" --items "1,2" --project-dir ~/Projects/project-a < /tmp/hh-plan.json
```
