...
`tests/unit/test-postinstall-detection.js` is the canonical test for root `postinstall.js` detection branches; the old Windows-only CI PATH simulation was removed in favor of this deterministic unit test.
